...
export function DropdownPlaceItem({ countryCode, country, place }: DropdownPlaceItemProps) {
  return (
    <li className='flex items-center gap-3 p-2 hover:bg-Neutral-700 rounded-md cursor-pointer transition-colors'>
